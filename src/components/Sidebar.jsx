        ...
        <div className="container mt-5 pt-5">
            ...
            <div className="row">
                ...
                <div className="col-lg-9 col-12">
                    <h2 className="mb-4 fw-bolder text-dark">Hotels Listing <span className="text-muted fs-5">(Showing 45 results)</span></h2>
                    
                    <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                        
                        <div className="col">
                            <div className="card h-100 shadow-sm border-0">
                                <img src="https://images.unsplash.com/photo-1566073771259-d3687878078a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1ODU1MzN8MHwxfHNlYXJjaHwxfHxob3RlbHxlbnwwfHx8fDE3MTQ1NzE2NDh8MA&ixlib=rb-4.0.3&q=80&w=400" className="card-img-top" alt="Hotel Image 1"/>
                        ...
                        <div className="col">
                            <div className="card h-100 shadow-sm border-0">
                                <img src="https://images.unsplash.com/photo-1582719478252-65e7b738e1f9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1ODU1MzN8MHwxfHNlYXJjaHwzfHxob3RlbHxlbnwwfHx8fDE3MTQ1NzE2NDh8MA&ixlib=rb-4.0.3&q=80&w=400" className="card-img-top" alt="Hotel Image 3"/>
                                <div className="card-body">
